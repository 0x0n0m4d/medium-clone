    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          sideOffset={3}
        >
          <DropdownMenu.Item className="group relative flex flex-col leading-none outline-none min-h-[182px] border-b border-solid border-gray-100 items-center justify-center gap-y-5">
